...
(
    ...
    localparam PAD12 = log2ceil(64'h20a8 - 64'h20a0); 
    localparam PAD13 = log2ceil(64'h20aa - 64'h20a8); 
    localparam PAD14 = log2ceil(64'h10000000 - 64'h8000000); 
    // -------------------------------------------------------
    ...
    // ( 0x2060 .. 0x2070 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 28'h2060   ) begin
            src_channel = 15'b001000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
    end

    // ( 0x2070 .. 0x2080 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 28'h2070   ) begin
    ...
    // ( 0x2090 .. 0x20a0 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 28'h2090  && read_transaction  ) begin
            src_channel = 15'b000000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 14;
    end

    // ( 0x20a0 .. 0x20a8 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 28'h20a0   ) begin
            src_channel = 15'b000000000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0x20a8 .. 0x20aa )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 28'h20a8   ) begin
